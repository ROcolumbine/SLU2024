...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--lr', type=float, default=1e-4, help='learning rate') # rnn:1e-4 bert:2e-5 transformer:5e-5
    ...
    # dynamic lr
    arg_parser.add_argument('--step_size', default=5, type=int, help='step_size of learning rate scheduler')
    ...
    # use manul_transcript as part of train dataset
    arg_parser.add_argument('--train_manual', action='store_true', help='train with manual_transcript and asr')
    arg_parser.add_argument('--train_manual_c', default=2, type=int, help='manual_transcript use constant')
    return arg_parser